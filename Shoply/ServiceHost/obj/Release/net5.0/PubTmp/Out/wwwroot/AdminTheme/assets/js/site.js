...
async function SetCategory(id, name, backId) {
    debugger;
    ...
    if (id != undefined) {
        ...
        var btn = `
                <div style="cursor:pointer;" onclick='SetCategory(${backId},"${data1.parent}",${data1.parentId})'><i class="fa fa-2x fa-arrow-circle-right"></i></div> `;
        backwrapper.html('');
...
async function ChooseCategory(id, name, backId) {
    ...
    if (id != undefined) {
        ...
        let data1 = await response1.json();
        var btn = `
                <div style="cursor:pointer;" onclick='ChooseCategory(${backId},"${data1.parent}",${data1.parentId})'><i class="fa fa-2x fa-arrow-circle-right"></i></div> `;
        backwrapper.html('');
        backwrapper.append(btn);
